    ...
    public static function getString($path, $type = 'name')
    {
        $descriptions = [
            ...
            'AllowThirdPartyFraming_desc' => __(
                'Enabling this allows a page located on a different domain to call phpMyAdminLei '
            ...
            'Export_sql_metadata_name' => __('Export related metadata from phpMyAdminLei configuration storage'),
            ...
            'Form_Developer_desc' => __('Settings for phpMyAdminLei developers.'),
            ...
            'Form_Security_desc' => __(
                'Please note that phpMyAdminLei is just a user interface and its features do not '
                . 'limit MySQL.'
            ),
            ...
            'Form_Server_pmadb_desc' => __(
                'Configure phpMyAdminLei configuration storage to gain access to additional '
                . 'features, see [doc@linked-tables]phpMyAdminLei configuration storage[/doc] in '
                . 'documentation.'
            ),
            'Form_Server_tracking_name' => __('Changes tracking'),
            'Form_Server_tracking_desc' => __(
                'Tracking of changes made in database. Requires the phpMyAdminLei configuration '
                . 'storage.'
            ),
            ...
            'Form_Warnings_desc' => __('Disable some of the warnings shown by phpMyAdminLei.'),
            ...
            'IgnoreMultiSubmitErrors_desc' => __(
                'If enabled, phpMyAdminLei continues computing multiple-statement queries even if '
            ...
            'PmaNoRelation_DisableWarning_desc' => __(
                ...
                . 'Structure page if any of the required tables for the phpMyAdminLei '
                . 'configuration storage could not be found.'
            ),
            'PmaNoRelation_DisableWarning_name' => __('Missing phpMyAdminLei configuration storage tables'),
            ...
            'QueryHistoryDB_desc' => __(
                'Enable if you want DB-based query history (requires phpMyAdminLei configuration '
            ...
            'Servers_DisableIS_desc' => __(
                'More information on [a@https://github.com/phpmyadmin/phpmyadmin/issues/8970]phpMyAdminLei '
            ...
            'ShowSQL_desc' => __('Defines whether SQL queries generated by phpMyAdminLei should be displayed.'),
            ...
            'TrustedProxies_desc' => __(
                ...
                'specifies that phpMyAdminLei should trust a HTTP_X_FORWARDED_FOR ' .
            ...
            'VersionCheck_desc' => __('Enables check for latest version on main phpMyAdminLei page.'),
            'VersionCheck_name' => __('Version check'),
            'ProxyUrl_desc' => __(
                'The url of the proxy to be used when retrieving the information about the ' .
                'latest version of phpMyAdminLei or when submitting error reports. You need this ' .
                'if the server where phpMyAdminLei is installed does not have direct access to ' .
            ...
            'ZeroConf_desc' => __(
                'Enable Zero Configuration mode which lets you setup phpMyAdminLei '
