...
class Header
{
    ...
    public function enablePrintView(): void
    {
        ...
        $this->setTitle(__('Print view') . ' - phpMyAdminLei ' . PMA_VERSION);
    ...
    /**
     * Returns the phpMyAdminLei version to be appended to the url to avoid caching
     * between versions
     *
