...
class Table
{
    ...
    /**
     * Return UI preferences for this table from phpMyAdminLei database.
     *
     * @return array
     */
    protected function getUiPrefsFromDb()
    {
        ...
        // Read from phpMyAdminLei database
    ...
    /**
     * Save this table's UI preferences into phpMyAdminLei database.
     *
     * @return true|Message
     */
