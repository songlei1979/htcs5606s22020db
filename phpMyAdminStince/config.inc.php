...
$cfg['Servers'][$i]['user'] = 't5cp0fex7qp4vels'; //change to yours
$cfg['Servers'][$i]['password'] = 'y9xdkhoq1uq2j07z'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'dno6xji1n8fm828n.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
