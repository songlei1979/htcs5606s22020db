...
class DatabaseInterface
{
    ...
    public function tryQuery(
        ...
        if ($debug) {
            ...
            if ($GLOBALS['cfg']['DBG']['sqllog']) {
                ...
                openlog('phpMyAdminLei', LOG_NDELAY | LOG_PID, LOG_USER);
            ...
            if (! $this->tryQuery($sql_query_tz)) {
                $error_message_tz = sprintf(
                    __(
                        ...
                        . 'phpMyAdminLei is currently using the default time zone '
    ...
    /**
     * This function checks and initialises the phpMyAdminLei configuration
