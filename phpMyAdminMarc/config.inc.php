...
$cfg['Servers'][$i]['user'] = 'kec4kj9vpzbctojt'; //change to yours
$cfg['Servers'][$i]['password'] = 'apwya9mj52zmgse2'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'zj2x67aktl2o6q2n.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
