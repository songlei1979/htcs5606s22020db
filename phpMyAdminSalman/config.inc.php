...
$cfg['Servers'][$i]['user'] = 'vh33o5giqh8eknbz'; //change to yours
$cfg['Servers'][$i]['password'] = 'bcebupl37uuf2lql'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'ijj1btjwrd3b7932.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
