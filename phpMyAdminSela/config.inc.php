...
$cfg['Servers'][$i]['user'] = 'g2kw8pwi5wbspqkm'; //change to yours
$cfg['Servers'][$i]['password'] = 'tur40fxp4c33fs82'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'arfo8ynm6olw6vpn.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
