    ...
    public function index(): string
    {
        ...
        if (isset($_SESSION['partial_logout'])) {
            $partialLogout = Message::success(__(
                ...
                . 'from phpMyAdminLei, you need to logout from all servers.'
            ))->getDisplay();
        ...
        if ($server > 0) {
            ...
            if (! $cfgRelation['allworks']
                ...
                $messageText = __(
                    'The phpMyAdminLei configuration storage is not completely '
        ...
        if (! extension_loaded('mbstring')) {
            trigger_error(
                __(
                    ...
                    . ' a multibyte charset. Without the mbstring extension phpMyAdminLei'
            ...
            if ($gc_time < $cfg['LoginCookieValidity']) {
                trigger_error(
                    __(
                        ...
                        'in phpMyAdminLei, because of this, your login might expire sooner ' .
                        'than configured in phpMyAdminLei.'
                    ),
                    E_USER_WARNING
                );
            }
        ...
        if ($cfg['LoginCookieStore'] != 0
            ...
            trigger_error(
                __(
                    ...
                    'phpMyAdminLei, because of this, your login will expire sooner than ' .
                    'configured in phpMyAdminLei.'
                ),
                E_USER_WARNING
            );
        }
        ...
        if (@file_exists(ROOT_PATH . 'config')) {
            trigger_error(
                __(
                    ...
                    'still exists in your phpMyAdminLei directory. It is strongly ' .
                    'recommended to remove it once phpMyAdminLei has been configured. ' .
            ...
            trigger_error(
                sprintf(
                    __(
                        ...
                        'phpMyAdminLei is not able to cache templates and will ' .
