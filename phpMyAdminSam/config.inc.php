...
$cfg['Servers'][$i]['user'] = 'd5iqslr5d9xtf5e7'; //change to yours
$cfg['Servers'][$i]['password'] = 'nce2zlolndscddyi'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'k2fqe1if4c7uowsh.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
