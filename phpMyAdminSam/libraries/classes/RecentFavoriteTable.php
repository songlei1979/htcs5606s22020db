...
class RecentFavoriteTable
{
    ...
    /**
     * Returns recently used tables or favorite from phpMyAdminLei database.
     *
     * @return array
     */
    public function getFromDb()
    {
        // Read from phpMyAdminLei database, if recent tables is not in session
        $sql_query
    ...
    /**
     * Save recent/favorite tables into phpMyAdminLei database.
     *
     * @return true|Message
     */
