...
class Index
{
    ...
    /**
     * Checks for newest phpMyAdminLei version and sets result as a new notice
     *
     * @return void
     */
    public static function versionCheck()
    {
        ...
        if ($version_upstream > $version_local) {
            ...
            self::messagesSet(
                ...
                $message_id,
                __('Version check'),
                sprintf(__('A newer version of phpMyAdminLei is available and you should consider upgrading. The newest version is %s, released on %s.'), $version, $date)
            );
        } else {
