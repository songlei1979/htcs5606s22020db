...
$cfg['Servers'][$i]['user'] = 'zwtccshi5x8h5pvx'; //change to yours
$cfg['Servers'][$i]['password'] = 'j6idgpckpu4s42xh'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'lolyz0ok3stvj6f0.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
