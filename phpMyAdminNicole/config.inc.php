...
$cfg['Servers'][$i]['user'] = 'qrzgb3mx9k0wl0ko'; //change to yours
$cfg['Servers'][$i]['password'] = 'p2hohc6r9awsbfjy'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'u0zbt18wwjva9e0v.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
