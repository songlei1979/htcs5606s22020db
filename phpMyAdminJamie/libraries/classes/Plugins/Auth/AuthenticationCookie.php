...
/**
 * Cookie Authentication plugin for phpMyAdminLei
 *
...
class AuthenticationCookie extends AuthenticationPlugin
{
    ...
    public function showLoginForm()
    {
        ...
        if ($GLOBALS['cfg']['DBG']['demo']) {
            echo '<fieldset>';
            echo '<legend>' , __('phpMyAdminLei Demo Server') , '</legend>';
            printf(
                __(
     ...
     * parameters used in older phpMyAdminLei versions or by wrong openSSL
     * configuration.
     *
