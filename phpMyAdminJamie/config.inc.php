...
$cfg['Servers'][$i]['user'] = 'pl5olm9uaqn9xhli'; //change to yours
$cfg['Servers'][$i]['password'] = 'o7mk03t99ecbrw8c'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'ctgplw90pifdso61.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
