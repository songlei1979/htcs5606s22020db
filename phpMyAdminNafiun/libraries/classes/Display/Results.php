...
class Results
{
    ...
    private function _getTableBody(
        ...
        // the phpMyAdminLei GUI should support row delete/edit only for such
        // tables.
        // Although always using keys is arguably the prescribed way of
        // defining a relational table, it is not required. This will in
        // particular be violated by the novice.
        // We want to encourage phpMyAdminLei usage by such novices. So the code
    ...
    private function _setParamForLinkForeignKeyRelatedTables(array &$map)
    {
        ...
        // native foreign keys or those defined in the phpMyAdminLei
