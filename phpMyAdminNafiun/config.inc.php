...
$cfg['Servers'][$i]['user'] = 't40tr04rjz84xosy'; //change to yours
$cfg['Servers'][$i]['password'] = 'yaxnofdhgxk1ogf2'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'k2pdcy98kpcsweia.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
