...
$cfg['Servers'][$i]['user'] = 'a7vsd5p699o1mif7'; //change to yours
$cfg['Servers'][$i]['password'] = 'uu5y3xzmj399r0ua'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'fnx6frzmhxw45qcb.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
