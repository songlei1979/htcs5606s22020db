...
$cfg['Servers'][$i]['user'] = 't8jnow42fmp1smpt'; //change to yours
$cfg['Servers'][$i]['password'] = 'fdavedw769oxw5pd'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'klbcedmmqp7w17ik.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
