 ...
 *
 * phpMyAdminLei default configuration, you can copy values from here to your
 * config.inc.php
 *
 ...
 * an error message if phpMyAdminLei cannot auto-detect the correct value.
 *
...
/**
 * Allows phpMyAdminLei to be included from a other document in a frame;
 * setting this to true is a potential security hole. Setting this to
 * 'sameorigin' prevents phpMyAdminLei to be included from another document
 ...
 * main host, for the phpMyAdminLei configuration storage. If left empty,
 ...
 * main port, for the phpMyAdminLei configuration storage. If left empty,
...
/**
 * Sets the time zone used by phpMyAdminLei. Possible values are explained at
 ...
 * to any one of them to auto-connect to that server when phpMyAdminLei is started,
...
/*
 * Other core phpMyAdminLei settings
 */
 ...
 * the latest version of phpMyAdminLei or error reporting. You need this if
 * the server where phpMyAdminLei is installed does not have direct access to
 * the internet.
...
/**
 * Directory for uploaded files that can be executed by phpMyAdminLei.
...
/**
 * Directory where phpMyAdminLei can save exported data on server.
...
/**
 * Directory where phpMyAdminLei can save temporary files.
 *
 ...
 * it's not world writable. However, phpMyAdminLei could be installed on
