...
class Core
{
    ...
    /**
     * displays the given error message on phpMyAdminLei error page in foreign language,
        ...
        if (extension_loaded('mbstring') && ! empty(ini_get('mbstring.func_overload'))) {
            self::fatalError(
                __(
                    ...
                    . 'configuration. This option is incompatible with phpMyAdminLei '
        ...
        if (! function_exists('ini_get') || ! function_exists('ini_set')) {
            self::fatalError(
                __(
                    ...
                    . 'phpMyAdminLei requires these functions!'
                )
            );
        }
    }
