...
$cfg['Servers'][$i]['user'] = 'k4j7jgjpv0fuxdca'; //change to yours
$cfg['Servers'][$i]['password'] = 'ltbt9xigi8kadool'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'nba02whlntki5w2p.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
