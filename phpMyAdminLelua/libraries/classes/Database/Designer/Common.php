    ...
    public function saveDisplayField($db, $table, $field)
    {
        ...
        if (! $cfgRelation['displaywork']) {
            return [
                false,
                _pgettext(
                    'phpMyAdminLei configuration storage is not configured for "Display Features" on designer when user tries to set a display field.',
                    'phpMyAdminLei configuration storage is not configured for "Display Features".'
                ),
            ];
        }
