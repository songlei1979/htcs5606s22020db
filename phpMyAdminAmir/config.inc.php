...
$cfg['Servers'][$i]['user'] = 'vy6x4wlh7erapgil'; //change to yours
$cfg['Servers'][$i]['password'] = 'seteqj3cpkfycdnt'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'kf3k4aywsrp0d2is.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
