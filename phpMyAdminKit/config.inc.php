...
$cfg['Servers'][$i]['user'] = 'h1r174kgefa2bwv1'; //change to yours
$cfg['Servers'][$i]['password'] = 'nz1tdqgzvtixcxel'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'c584md9egjnm02sk.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
