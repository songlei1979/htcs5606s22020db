...
if (isset($_POST['submit_export'])
    ...
    // export to JSON file
    $response->disable();
    $filename = 'phpMyAdminLei-config-' . urlencode(Core::getenv('HTTP_HOST')) . '.json';
    ...
    // export to JSON file
    $response->disable();
    $filename = 'phpMyAdminLei-config-' . urlencode(Core::getenv('HTTP_HOST')) . '.php';
    Core::downloadHeader($filename, 'application/php');
    $settings = $userPreferences->load();
    echo '/* ' . __('phpMyAdminLei configuration snippet') . " */\n\n";
