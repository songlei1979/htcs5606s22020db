...
$cfg['Servers'][$i]['user'] = 'clirofc82mncomex'; //change to yours
$cfg['Servers'][$i]['password'] = 'oliv570vcjycahnz'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 's9xpbd61ok2i7drv.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
