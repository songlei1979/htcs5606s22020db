...
$cfg['Servers'][$i]['user'] = 's2f58oji261lh6oi'; //change to yours
$cfg['Servers'][$i]['password'] = 'olvhcvw4cdwyn3em'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'u3r5w4ayhxzdrw87.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
